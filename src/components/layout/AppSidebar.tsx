...
export function AppSidebar() {
  ...
  return <Sidebar className="min-h-screen border-r border-white/10 bg-gradient-to-b from-slate-950 to-gray-900 w-64 flex flex-col">
            ...
            <SidebarMenu>
              ...
              return <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <Link to={item.url} className={clsx("flex items-center gap-2 px-3 py-2 w-full rounded transition-colors", isActive ? "bg-purple-600/30 text-purple-200 font-semibold shadow" : "hover:bg-purple-400/10 text-gray-300")} aria-current={isActive ? "page" : undefined}>
